...
const validateCreateDIRGRN = [
    ...
    body('details')
        .isArray({ min: 1 }).withMessage('At least one detail item is required'),
    ...
    body('details.*.unitQty')
        ...
        .custom(value => value >= 0).withMessage('Quantity cannot be negative'),
