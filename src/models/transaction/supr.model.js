class SUPRHeader {
    constructor(data) {
        this.type = data.type || data.HED_TYPE || 'SUPR';
...
class SUPRDetail {
    constructor(data) {
        ...
        this.type = data.type || data.DET_TYPE || 'SUPR';
        ...
        this.additionsQty = data.additionsQty || data.DET_ADDTIONSQTY || 0;
        this.deductionsQty = data.deductionsQty || data.DET_DEDUCTIONSQTY || 0;
        ...
        this.grnQty = data.grnQty || 0; // Original GRN quantity for validation
        this.createdDate = data.createdDate || data.CR_DATE || new Date();
        this.createdBy = data.createdBy || data.CR_BY || '';
        this.modifiedDate = data.modifiedDate || data.MD_DATE || null;
        this.modifiedBy = data.modifiedBy || data.MD_BY || null;
...
class SUPRSearchCriteria {
    constructor(criteria) {
        this.searchText = criteria.searchText || '';
        this.type = criteria.type || 'SUPR';
