class CORHeader {
    constructor(data) {
        this.type = data.type || data.HED_TYPE || 'COR';
        ...
        this.supName = data.supName || data.HED_SUPNAME || '';
        this.cusCode = data.cusCode || data.HED_CUSCODE || '';
        this.cusName = data.cusName || data.HED_CUSNAME || '';
...
class CORDetail {
    constructor(data) {
        ...
        this.type = data.type || data.DET_TYPE || 'COR';
        ...
        this.invoiceQty = data.invoiceQty || 0; // Original invoice quantity
        this.createdDate = data.createdDate || data.CR_DATE || new Date();
        this.createdBy = data.createdBy || data.CR_BY || '';
        this.modifiedDate = data.modifiedDate || data.MD_DATE || null;
        this.modifiedBy = data.modifiedBy || data.MD_BY || null;
...
class CORSearchCriteria {
    constructor(criteria) {
        this.searchText = criteria.searchText || '';
        this.type = criteria.type || 'COR';
